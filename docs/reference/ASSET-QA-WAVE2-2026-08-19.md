...
générées, finalisées et inspectées : 124 assets sont distribués par le client et
28 planches restent des références de sculpture pour les créatures. Le manifeste
public contient désormais 167 entrées pour 9 610 264 octets, sous le budget ferme
de 12 582 912 octets.
...
| Références de créatures | 28 | `docs/reference/creatures/` |
| **Total** | **152** | 124 publiques + 28 références |
...
- Les créatures restent animées et procédurales. Les planches guident une future
  passe de resculpture ; aucun billboard 2D n'a été substitué aux rigs.
